	...
	: CTClientUIBase(pParent, pDesc)
{
	...
	{
		ID_CTRLINST_MARK_TYPE,			///< 문양
		ID_CTRLINST_BACK_TYPE,			///< 바탕
		ID_CTRLINST_MCOL_BAR,			///< 문양색
		ID_CTRLINST_BCOL1_BAR,			///< 바탕색1
		ID_CTRLINST_BCOL2_BAR,			///< 바탕색2
	};

	static const DWORD dwLEFT[] = 
	{
		ID_CTRLINST_MARK_LB,			///< 문양
		ID_CTRLINST_BACK_LB,			///< 바탕
		ID_CTRLINST_MCOL_LB,			///< 문양색
		ID_CTRLINST_BCOL1_LB,			///< 바탕색1
		ID_CTRLINST_BCOL2_LB,			///< 바탕색2
	};

	static const DWORD dwRIGHT[] = 
	{
		ID_CTRLINST_MARK_RB,			///< 문양
		ID_CTRLINST_BACK_RB,			///< 바탕
		ID_CTRLINST_MCOL_RB,			///< 문양색
		ID_CTRLINST_BCOL1_RB,			///< 바탕색1
		ID_CTRLINST_BCOL2_RB,			///< 바탕색2
	};
