...
/// <summary>
/// The fixed 16-byte little-endian TNetLib packet header (same wire format as TLogin), mirroring
/// <c>struct _tagPACKETHEADER</c>:
/// <code>
...
/// </code>
/// TWorld speaks the server↔server planes which are <b>plaintext</b> (no RC4/XOR), so dwNumber and
/// llChkSUM stay zero and are never validated.
/// </summary>
