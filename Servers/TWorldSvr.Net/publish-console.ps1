...
$proj = Join-Path $PSScriptRoot 'TWorld.Server/TWorld.Server.csproj'
...
Get-ChildItem (Join-Path $PSScriptRoot 'publish') -Recurse -Include 'TWorld.Server', 'TWorld.Server.exe' |
