...
/// Reads past the end return zero / empty (matching the C++ zero-fill behaviour). The patch link is
...
public sealed class PacketReader
{
    ...
    /// <summary>Advances past <paramref name="count"/> body bytes (mirrors the C++ <c>m_ptrOffset += n</c>).</summary>
