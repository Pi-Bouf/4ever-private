...
/// <summary>
/// Stored-procedure invocation helpers (same approach as TLogin.Data/TWorld.Data): procs are invoked as
/// positional <c>EXEC dbo.[Proc] @p0, @p1 OUTPUT</c> text so SQL Server binds by position — robust to
...
internal static class SqlExtensions
{
    ...
    public static ushort AsUShort(this SqlParameter p) => p.Value is null or DBNull ? (ushort)0 : Convert.ToUInt16(p.Value);
    ...
    public static ushort GetUShortSafe(this SqlDataReader r, int i) => r.IsDBNull(i) ? (ushort)0 : Convert.ToUInt16(r.GetValue(i));
    ...
    public static DateTime GetDateTimeSafe(this SqlDataReader r, int i) => r.IsDBNull(i) ? default : r.GetDateTime(i);
}
