...
/// scalars are little-endian. The 16-byte header is reserved up front; <see cref="ToArray"/> finalizes
/// <c>wSize</c>. dwNumber/checksum are left zero (server traffic is plaintext).
/// </summary>
public sealed class PacketWriter
{
    ...
    /// <summary>Appends raw bytes verbatim (e.g. a forwarded trailing blob from another packet).</summary>
