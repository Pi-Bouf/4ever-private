...
PREDEFINE_QUERY(CSPGetCustomCloak)
	...
	PREDEFINE_QUERY(CTBLMapMonAll)
	PREDEFINE_QUERY(CTBLMonPartyAll)
	...
	PREDEFINE_QUERY(CTBLQuestChartAll)
	PREDEFINE_QUERY(CTBLQuestConditionChartAll)
	PREDEFINE_QUERY(CTBLQuestRewardChartAll)
	PREDEFINE_QUERY(CTBLQuestTermChartAll)
	...
	PREDEFINE_QUERY(CTBLNpcItemAll)
	PREDEFINE_QUERY(CTBLMonItem)
	PREDEFINE_QUERY(CTBLMonItemAll)
	...
	PREDEFINE_QUERY(CTBLDestinationChartAll)
	...
	PREDEFINE_QUERY(CTBLSvrTopoAll)
