...
#define REG_SUBKEY					_T("Software\\TEST\\")
...
#define HOMEPAGE_NAME				_T("http://en.4story.gameforge.com")
#define LAUNCHERWEB_NAME			_T("http://en.4story.gameforge.com/launcher")
...
#define TOOLTIP_PREPATCH			_T("Download next patch in advance") //nove
#define COUNTRY_CODE				_T("int")
//=====================================================================================
