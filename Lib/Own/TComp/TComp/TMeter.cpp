...
{
	if(m_style & TMS_GROW_RIGHT)		{ size.cy = 0;						}//→
	else if(m_style & TMS_GROW_DOWN)	{ size.cx = 0;						}//↓	
	else if(m_style & TMS_GROW_LEFT)	{ size.cy = 0; size.cx = -size.cx;	}//←
	else								{ size.cx = 0; size.cy = -size.cy;	}//↑
}
